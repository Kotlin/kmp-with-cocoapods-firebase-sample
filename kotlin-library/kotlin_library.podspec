Pod::Spec.new do |spec|
    ...
    spec.dependency 'FirebaseABTesting', '12.13.0'
    spec.dependency 'FirebaseAnalytics', '12.13.0'
    spec.dependency 'FirebaseAppCheck', '12.13.0'
    spec.dependency 'FirebaseAppDistribution', '12.13.0-beta'
    spec.dependency 'FirebaseAuth', '12.13.0'
    spec.dependency 'FirebaseCore', '12.13.0'
    spec.dependency 'FirebaseCrashlytics', '12.13.0'
    spec.dependency 'FirebaseDatabase', '12.13.0'
    spec.dependency 'FirebaseFirestore', '12.13.0'
    spec.dependency 'FirebaseFirestoreInternal', '12.13.0'
    spec.dependency 'FirebaseInAppMessaging', '12.13.0-beta'
    spec.dependency 'FirebaseInstallations', '12.13.0'
    spec.dependency 'FirebaseMessaging', '12.13.0'
    spec.dependency 'FirebasePerformance', '12.13.0'
    spec.dependency 'FirebaseRemoteConfig', '12.13.0'
    spec.dependency 'FirebaseStorage', '12.13.0'
